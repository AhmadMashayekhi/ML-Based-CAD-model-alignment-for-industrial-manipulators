...
def show_open3d(template,source):
    template_ = o3d.geometry.PointCloud()
    source_ = o3d.geometry.PointCloud()
    template_.points = o3d.utility.Vector3dVector(template.detach().cpu().numpy()[0])
    source_.points = o3d.utility.Vector3dVector(source.detach().cpu().numpy()[0])
...
class PointNetLK(nn.Module):
    ...
    def iclk(self, template, source, maxiter): #Inverse Computational Lucas-Kanade
