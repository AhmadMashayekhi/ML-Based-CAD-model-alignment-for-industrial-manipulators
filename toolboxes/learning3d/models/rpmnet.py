...
class RPMNet(nn.Module):
    def __init__(self, feature_model=PPFNet()):
        ...
        self.feature_model = feature_model #renamed from feature_extractor
    ...
    def spam(self, xyz_template, norm_template, xyz_source, norm_source):
        ...
        self.feat_source = self.feature_model(xyz_source, norm_source)
        self.feat_template = self.feature_model(xyz_template, norm_template)
